...
class TestCompress:
    ...
    def test_max_tokens_ceiling_does_not_lower_threshold(self):
        """Configured max_tokens is an output ceiling, not a reservation."""
        assert ContextCompressor._compute_threshold_tokens(200000, 0.50) == 100000
        assert ContextCompressor._compute_threshold_tokens(200000, 0.50, None) == 100000
        assert ContextCompressor._compute_threshold_tokens(200000, 0.50, 65536) == 100000

    def test_max_tokens_ceiling_preserves_small_window_floor(self):
        """The small-window guard uses the real context window regardless of ceiling."""
