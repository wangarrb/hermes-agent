...
class ContextCompressor(ContextEngine):
    ...
    def _compute_threshold_tokens(
        ...
        """
        # Fork customization: do NOT subtract max_tokens from context_length.
        # The upstream logic treats max_tokens as "reserved output space", but
        # config.yaml's max_tokens is a *maximum limit*, not a per-request
        # reservation.  Subtracting it causes models with large max_tokens
        # (e.g. 128K on 200K context) to compress prematurely at ~64K.
