...
def _provider_alias_table() -> Dict[str, str]:
    ...
    if _ALIAS_TABLE is None:
        ...
        # Fork compatibility: existing auxiliary lanes use the historical
        # ``bailian`` spelling for the upstream Alibaba/DashScope provider.
        merged.setdefault("bailian", "alibaba")
        _ALIAS_TABLE = merged
    return _ALIAS_TABLE
