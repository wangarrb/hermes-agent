...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("mycompress", "Skill-guided compression wrapper", "Session",
               args_hint="[-n rounds] [focus topic]"),
...
#   - mycompress: skill-guided compression; reached via /hermes mycompress so
#     adding this fork command cannot silently clamp an established command.
_SLACK_VIA_HERMES_ONLY = frozenset({"topup", "moa", "debug", "mycompress"})
