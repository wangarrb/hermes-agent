...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("mycompress", "Compress with skill-guided summary (skill-backed)", "Session",
               cli_only=True, aliases=(), args_hint="[-n <rounds>] [focus topic]"),
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               ...
               subcommands=("list", "ls", "show", "create", "assign", "link", "unlink",
                            "claim", "next", "reset-current", "comment", "complete", "block", "unblock", "archive",
    ...
    CommandDef("listen-kanban",
               "Enter worker-loop: auto-claim and run kanban tasks in this pane",
               "Tools & Skills", cli_only=True,
               aliases=("lkn",),
               args_hint="[profile|--board <board> --assignee <name>|pause|resume|--reset|stop|status]",
               subcommands=("pause", "resume", "--reset", "stop", "status")),
    CommandDef("reset-kanban",
               "Reclaim the current interactive kanban task and return the listener to idle",
               "Tools & Skills", cli_only=True),
