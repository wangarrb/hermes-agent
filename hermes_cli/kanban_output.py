...
_TASK_DICT_FIELDS = (
    ...
    "target_branch", "generation", "delivery_state", "project_id",
...
def _task_to_dict(t: kb.Task) -> dict[str, Any]:
    ...
    d["common_dir"] = t.common_dir
    d["workspace_contract"] = t.workspace_contract
    d["delivery"] = t.delivery.to_dict() if t.delivery else None
    return d
