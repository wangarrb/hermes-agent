...
class AIAgent:
    ...
    def _apply_client_headers_for_base_url(self, base_url: str) -> None:
        ...
        if base_url_host_matches(base_url, "openrouter.ai"):
            ...
            # Fork customization: CCH requires a specific User-Agent to route correctly.
            # Spoofing openai-codex/0.121.0 (the real Codex CLI UA) prevents 503 format_type_mismatch.
